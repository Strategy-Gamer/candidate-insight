    ...
    <section className="max-w-6xl mx-auto font-sans text-gray-800">
      ...
      <div className="mb-6">
        ...
        <p className="text-lg text-justify">
          In the United States, public policy is enacted by the government through elected officials on behalf of their constituents. 
      ...
      <div>
        ...
        <ol className="list-decimal pl-8 space-y-3 text-lg text-justify">
          ...
          <li><span className="font-medium">Legitimation</span> - the process of gathering support for the policy through various means, such as referendums.</li>
